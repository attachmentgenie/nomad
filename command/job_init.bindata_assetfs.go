...
func commandAssetsConnectShortNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/connect-short.nomad", size: 997, mode: os.FileMode(436), modTime: time.Unix(1620938195, 0)}
...
func commandAssetsConnectNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/connect.nomad", size: 17842, mode: os.FileMode(436), modTime: time.Unix(1620938195, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func commandAssetsExampleShortNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/example-short.nomad", size: 324, mode: os.FileMode(436), modTime: time.Unix(1620938195, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func commandAssetsExampleNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/example.nomad", size: 16057, mode: os.FileMode(436), modTime: time.Unix(1620938195, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
